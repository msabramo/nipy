...
class NumpyDoctest(npd.Doctest):
    ...
    def configure(self, options, config):
        ...
        if self.enabled:
            ...
            # both.  In practice the Unplugger plugin would cover us when run
            # from a standard numpy.test() call; this is just in case someone
            # wants to run our plugin outside the numpy.test() machinery
